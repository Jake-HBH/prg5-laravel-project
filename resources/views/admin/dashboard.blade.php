    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 text-gray-900 dark:text-gray-100 space-y-4">
                ...
                <!-- tag overview link -->
                <a href="{{ route('admin.species.index') }}" class="block p-4 bg-yellow-500 text-white rounded-lg shadow hover:bg-yellow-600">
                    Tags
                </a>

                <!--  user overview link -->
                <a href="{{ route('admin.users.index') }}" class="block p-4 bg-green-500 text-white rounded-lg shadow hover:bg-green-600">
                    Users
                </a>
